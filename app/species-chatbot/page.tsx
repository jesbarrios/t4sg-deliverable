...
const handleSubmit = async () => {
    ...
    try {
      ...
      setChatLog((prev) => [
        ...prev,
        { role: "bot", content: "Sorry, I'm having trouble responding right now. Please try again." },
      ]);
    }
  };
      ...
      <div className="mx-auto mt-6">
        ...
        <div className="mt-4 flex gap-2">
          <textarea
            ...
            className="flex-1 resize-none overflow-hidden rounded border border-border bg-background p-2 text-sm text-foreground focus:outline-none"
          />
          <button
            type="button"
